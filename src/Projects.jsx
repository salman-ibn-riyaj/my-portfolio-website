  ...
  const allProjects = [
    {
      title: "KeenKeeper",
      description:
        "A relationship management system built with Next.js that allows users to track communication history with friends and family. It features dynamic routing and a custom 'Not Found' page implementation.",
    ...
    },
    {
      ...
      description:
        "There you can see my all the projects those i made with my best effort and consistent patience.",
            ...
            >
              ...
              <ul className="flex flex-wrap gap-3 font-mono text-xs text-blue-300">
                {project.tags.map((tag) => (
                  <li key={tag} className="bg-blue-400/10 px-2 py-1 rounded">
                    {tag}
                  </li>
                ))}
              </ul>
